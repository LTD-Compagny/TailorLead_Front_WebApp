...
export default function MesEntreprises() {
  ...
  const [columns, setColumns] = useState<ColumnConfig[]>([
    { id: 'siren', label: 'SIREN', key: 'siren', visible: true, order: 0, filter: [], filterSearch: '', filterOpen: false },
    { id: 'nom', label: 'Nom', key: 'nom', visible: true, order: 1, filter: [], filterSearch: '', filterOpen: false },
    { id: 'ville', label: 'Ville', key: 'ville', visible: true, order: 2, filter: [], filterSearch: '', filterOpen: false },
    { id: 'secteur', label: 'Secteur', key: 'secteur', visible: true, order: 3, filter: [], filterSearch: '', filterOpen: false },
    { id: 'ca', label: 'CA', key: 'ca', visible: false, order: 4, filter: [], filterSearch: '', filterOpen: false },
    { id: 'effectif', label: 'Effectif', key: 'effectif', visible: false, order: 5, filter: [], filterSearch: '', filterOpen: false },
    { id: 'dateCreation', label: 'Date de création', key: 'dateCreation', visible: false, order: 6, filter: [], filterSearch: '', filterOpen: false },
    { id: 'formeJuridique', label: 'Forme juridique', key: 'formeJuridique', visible: false, order: 7, filter: [], filterSearch: '', filterOpen: false },
  ])
                              ...
                              >
                                {(() => {
                                  ...
                                  const uniqueValues = Array.from(new Set(
                                    selectedRecherche.entreprises
                                      .map(ent => {
                                        const value = (ent as any)[column.key]
                                        return value ? value.toString().trim() : ''
                                      })
                                      .filter(v => v !== '')
                                  )).sort()
                          ...
                          {(() => {
                            ...
                            let filteredEntreprises = selectedRecherche.entreprises.filter((entreprise) => {
                              return visibleColumns.every(column => {
                                ...
                                const value = (entreprise as any)[column.key]?.toString().trim() || ''
