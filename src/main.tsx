...
import MesReglages from './pages/MesReglages.tsx'
import MonAbonnement from './pages/MonAbonnement.tsx'
  ...
  <React.StrictMode>
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/compte/reglages" element={<MesReglages />} />
        <Route path="/compte/abonnement" element={<MonAbonnement />} />
